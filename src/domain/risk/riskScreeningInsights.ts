...
export const screeningInsights: Record<string, Record<ScreeningMetricKey, ScreeningInsight>> = {
  'ev-battery-fire': {
    ...
    adverseSelection: insight('높음', ['BMS 사전 진단 데이터 요구 가능'], ['인수심사 가이드 · SAMPLE'], '노후 차종과 관리 상태를 구분할 수 있는지 확인합니다.', 'positive'),
    moralHazard: insight('보통', ['충전기 방치 등 관리 부실 가능성'], ['이상거래 탐지 분석 · SAMPLE'], '자기부담금과 점검 조건의 통제 효과를 검토합니다.'),
  ...
  'generative-ai-copyright': {
    demand: insight('78%', ['IT 기업의 지식재산 소송 대비 문의 증가'], ['기업 B2B 설문 · SAMPLE'], '기업용 특약 수요를 별도 검증합니다.', 'positive'),
    ...
    adverseSelection: insight('보통', ['사전 필터링과 데이터 관리 체계 점검 필요'], ['인수심사 가이드 · SAMPLE'], '관리체계가 확인된 기업의 조건부 인수를 검토합니다.'),
    moralHazard: insight('낮음', ['고의 도용은 면책 검토 대상'], ['법무 검토안 · SAMPLE'], '고의성과 관리 소홀의 경계를 약관에 명시해야 합니다.', 'positive'),
    dataConfidence: insight('72%', ['국내 데이터 누적 기간이 짧음'], ['빅데이터 분석 · SAMPLE'], '불확실성을 반영한 안전율 검토가 필요합니다.'),
  ...
  'commercial-drone': {
    ...
    accumulation: insight('3.0', ['현재는 단발성 개별 사고가 중심'], ['사고 DB · SAMPLE'], '관제 장애로 인한 동시 사고 가능성은 별도 확인합니다.', 'positive'),
    ...
    moralHazard: insight('낮음', ['원격 비행 제어 기록 보존 가능'], ['이상행위 검증자료 · SAMPLE'], '로그 위변조 방지 수준을 먼저 확인합니다.', 'positive'),
  ...
  'autonomous-level4': {
    ...
    adverseSelection: insight('낮음', ['임의 소프트웨어 개조 확인이 어려움'], ['인수심사 검토 · SAMPLE'], '순정 소프트웨어와 업데이트 이력을 가입 조건으로 검토합니다.', 'critical'),
  ...
  'deepfake-phishing': {
    ...
    adverseSelection: insight('낮음', ['보안 취약 사업장의 가입 집중 가능성'], ['인수심사 가이드 · SAMPLE'], '이중 승인 절차 등 통제 수준을 인수 조건으로 검토합니다.', 'critical'),
    moralHazard: insight('높음', ['내부자 공모와 자작극 가능성'], ['이상거래 검수 · SAMPLE'], '수사기관 신고와 거래 증빙을 보상 조건으로 검토합니다.', 'critical'),
  ...
  'urban-flooding': {
    ...
    adverseSelection: insight('보통', ['상습 침수지역 계약 집중 가능', '건물 지하층 사용 여부 확인 필요'], ['침수흔적도 · 원문 확인 필요', '인수 현장조사 · SAMPLE'], '주소·층수·방재시설을 인수조건에 반영할지 검토합니다.'),
    moralHazard: insight('낮음', ['기상관측과 현장 침수흔적으로 사고 확인 가능'], ['기상관측망 · 원문 확인 필요', '손해사정 보고서 · SAMPLE'], '잔존물 관리와 사고 확인 기준을 명확히 합니다.', 'positive'),
    ...
    legalExposure: insight('고위험', ['재난지원금과 보험금 관계 설명 필요', '침수 방지 의무와 관리책임 분쟁 가능'], ['재난 및 안전관리 기본법 · 원문 확인 필요', '보험 약관 검토 · SAMPLE'], '공적지원 중복과 관리책임 범위를 약관에서 검토합니다.', 'critical'),
  },
  'enterprise-ransomware': {
    ...
    moralHazard: insight('보통', ['가입 후 보안투자 축소 가능', '사고 신고 지연 시 손해 확대'], ['사이버보험 인수 사례 · SAMPLE'], '최소 보안유지 의무와 신속 통지조항을 검토합니다.'),
    dataConfidence: insight('70%', ['공개 사고보다 미신고 사고가 많아 손해분포 왜곡 가능'], ['KISA 신고통계 · 원문 확인 필요', '보험사 사고 DB · SAMPLE'], '내부 사고데이터와 외부 위협정보의 결합 기준이 필요합니다.'),
  ...
  'ess-ups-battery-fire': {
    ...
    measurability: insight('4.0', ['BMS 온도·전압·충방전 로그 활용 가능'], ['BMS 운영기록 · SAMPLE', '전기설비 점검기록 · SAMPLE'], '상태기반 인수와 원인 분석에 필요한 로그 기준을 확인합니다.', 'positive'),
    ...
    moralHazard: insight('낮음', ['화재 원인이 로그와 감식으로 확인되는 설비사고'], ['소방감식 · SAMPLE', 'BMS 로그 · SAMPLE'], '유지보수 의무와 로그 보존 조건을 검토합니다.', 'positive'),
  ...
  'heatwave-health-income-loss': {
    ...
    adverseSelection: insight('보통', ['기저질환·직업·거주환경별 위험차 존재'], ['건강고지 · SAMPLE', '직업위험등급 · SAMPLE'], '고령·야외근로 등 위험군별 가입조건을 검토합니다.'),
    ...
    legalExposure: insight('중위험', ['기상지수와 실제 손해 불일치 가능', '근로자 보호조치와 산재보상 관계 검토 필요'], ['산업안전보건법 · 원문 확인 필요', '보험 약관 검토 · SAMPLE'], '중복보상과 기초위험 설명 기준을 검토합니다.'),
  },
  'platform-worker-transit-accident': {
    ...
    measurability: insight('4.0', ['앱 접속·배차·GPS·운행시간 데이터 활용 가능'], ['플랫폼 운행로그 · SAMPLE', '경찰 사고기록 · 원문 확인 필요'], '업무 중 사고 여부와 노출량 산정 기준을 검토합니다.', 'positive'),
    adverseSelection: insight('높음', ['운행거리·시간대·사고이력으로 위험선별 가능'], ['운행로그 · SAMPLE', '보험개발원 사고이력 · 원문 확인 필요'], '노출기반 요율과 안전운전 지표의 활용 가능성을 검토합니다.', 'positive'),
    moralHazard: insight('보통', ['업무·비업무 운행 구분을 둘러싼 분쟁 가능'], ['GPS·배차기록 · SAMPLE'], '앱 로그인과 배차수락 중 보장개시 기준을 정의해야 합니다.'),
    dataConfidence: insight('73%', ['플랫폼 로그는 정밀하나 사업자별 데이터 형식이 상이'], ['플랫폼사 운행 DB · SAMPLE', '근로복지공단 · 원문 확인 필요'], '표준 스키마와 개인정보 동의체계를 먼저 확인합니다.'),

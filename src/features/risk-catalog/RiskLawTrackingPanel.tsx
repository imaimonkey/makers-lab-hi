    ...
    <section className="risk-law-tracking" aria-labelledby="risk-law-tracking-title">
      ...
      <div className="risk-law-detail" aria-live="polite">
        {selectedWithPrecedents ? <>
          ...
          {developerMode ? <div className="risk-law-update-label">ACTUAL ARTICLE · STEP 2 {selectedWithPrecedents.lastUpdated}</div> : null}
          ...
          {developerMode ? <p className="risk-law-disclaimer">ACTUAL ARTICLE · Step 2 law 결과입니다. 원문에 없는 판례·손해 사례는 추가하지 않고 확인 필요로 표시합니다.</p> : null}
